                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><input type="text" name="nama_sub_gedung" value="${subgedung.nama_sub_gedung}" readonly='readonly'></td>
                                        ...
                                        <tr><td>Harga Sewa /jam</td>
                                            <td>:</td>
                                            <td><input type="text" name="harga" value="${subgedung.harga}" readonly='readonly'>
                                        ...
                                        <tr><td>Kapasitas</td>
                                            <td>:</td>
                                            <td><input type="text" name="kapasitas" value="${subgedung.kapasitas}" readonly='readonly'>

                                             orang</td>
                                        </tr>
                                        <tr><td>Luas </td>
                                            <td>:</td>
                                            <td><input type="text" name="luas" value="${subgedung.luas}" readonly='readonly'>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <textarea name="fasilitas_sub" value="${subgedung.nama_sub_gedung}" readonly='readonly'>${subgedung.fasilitas_sub}</textarea>
                                            </td>
                                        </tr>
                                         ...
                                         <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <textarea name="deskripsi_sub" value="${subgedung.nama_sub_gedung}" readonly='readonly'>${subgedung.deskripsi_sub}></textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                        <td rowspan=6> <img src="../foto/${subgedung.foto}" width="150" height="200" alt="" /></td>
                                        </tr>
