                            ...
                            <div class="entry">
                                <form method='post'>
                                    ...
                                    <table>
                                        ...
                                        <%Iterator itr;%>
                                        <% List sewa_list = (List) request.getAttribute("pemilik_0");
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="KonfirmasiPermintaanSewa?konfirm=1&&idSewa=<%=sewa.getIdSewa()%>&&idSubGedung=<%=sewa.getIdSubGedung()%>">Terima</a> / <a href="KonfirmasiPermintaanSewa?konfirm=0&&idSewa=<%=sewa.getIdSewa()%>&&idSubGedung=<%=sewa.getIdSubGedung()%>">Tolak</a></td>
                                        </tr>
                                        <%}%>
                                    </table>
                                    <br>
                                    ...
                                    <table>
                                        ...
                                        <%Iterator itr2;%>
                                        <% List sewa_list2 = (List) request.getAttribute("pemilik_1");
