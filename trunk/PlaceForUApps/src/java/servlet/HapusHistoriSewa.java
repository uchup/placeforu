 ...
 * @author Ika
 */
public class HapusHistoriSewa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ds.removeSewa(idSewa);

        RequestDispatcher requestDispatcher =
                request.getRequestDispatcher("/successDeleting.jsp");
        page = "HistoriSewa";
        message = "Histori sewa berhasil dihapus";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(HapusHistoriSewa.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
